@php use App\Enums\Admin\AdminEmployersSearchEnum as SearchEnum;use App\Enums\Actions\BanDurationEnum;use App\Enums\Actions\ReasonToBanEmployerEnum; @endphp
<x-admin.layout>
    <x-admin.header>
