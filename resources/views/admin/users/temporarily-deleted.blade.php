@php
    use App\Enums\Admin\AdminDeletedUserSearchEnum as SearchEnum;
...
<x-admin.layout>
    ...
    <section class="mx-auto w-3/4 my-10">
        ...
        <x-admin.table.default>
            ...
            <x-slot:description>
                <span>You can restore temporarily deleted users</span>
            ...
            <x-admin.table.thead>
                ...
                <th scope="col" class="px-3 py-3 text-sm">
                    <button type="button" class="sort-link flex items-center space-x-1" data-sort="removed-time">
                        <span class="uppercase">Deleted at</span>
                        <svg class="w-4 h-4 text-gray-800 dark:text-black" aria-hidden="true" id="asc-icon"
                             xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="m5 15 7-7 7 7"/>
            ...
            <x-admin.table.tbody class="temporarily-deleted">
                <!--From JS-->
            </x-admin.table.tbody>
        </x-admin.table.default>
    ...
    @pushonce('vite')
        @vite(['resources/assets/js/admin/tables/temporarilyDeletedTable.js'])
    @endpushonce
</x-admin.layout>
