<x-admin.layout>
    <x-admin.header>
        ...
        In this section, you can view all hard-skills that are using in application. You also can edit, delete and
        create them.
    </x-admin.header>
    ...
    <section class="mx-auto w-1/2 my-10">
        ...
        @endsession
        @error('skill')
        <x-admin.alerts.error>{{ $message }}</x-admin.alerts.error>
        @enderror
                ...
                <div class="flex items-center justify-between">
                    <div class="relative">
                        ...
                        <input type="search" name="search" id="search-dropdown"
                               class="block w-full ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500"
                               placeholder="Docker..." required/>
    ...
    <section class="mx-auto flex justify-center items-center">
        <x-admin.card-icon>
            <x-slot:icon>
                <svg class="h-8 w-8 text-red-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="flex gap-3 items-end">
                    <div>
                        <label for="permission"
                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Skill name, tool
                            name etc.</label>
    ...
    <div id="static-modal" tabindex="-1"
         class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-lg max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <svg class="float-start w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                         xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <button type="button"
                            class="hide-modal-btn text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <form action="{{ route('admin.skills.edit', ['skill' => ':id']) }}" method="POST" id="edit-form">
                        ...
                        @method('PATCH')
                        <div class="mb-6">
                            <label for="skill-name-edit"
                                   class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                            <input type="text" id="skill-name-edit" name="skill"
                ...
                <div class="flex items-center justify-end p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button data-modal-hide="static-modal" form="edit-form" type="submit"
    ...
    <div id="popup-modal" tabindex="-1"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button"
                        class="hide-modal-btn absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to
                        delete <span id="skillName" class="font-bold"></span> skill? This skill will be removed from all
                        associated vacancies.</h3>
                    <form action="{{ route('admin.skills.delete', ['skill' => ':id']) }}" id="delete-form"
                          method="POST">
                        @csrf
                        @method('DELETE')
