...
<x-admin.layout>
    <x-admin.header>
        <x-slot:title>Vacancies for moderation</x-slot:title>
        In this section, you can view all vacancies that need verifying before it will be published.
    </x-admin.header>
    ...
    <section class="mx-auto w-11/12 my-10">
        ...
        <x-admin.table.default>
            ...
            <x-slot:description>
                <span>The full list of vacancies to moderate</span>
                <div class="flex items-center justify-between">
                    <div class="flex justify-end flex-col my-4">
            ...
            <x-admin.table.tbody class="vacancies-moderate-body">
                <!--From JS-->
            </x-admin.table.tbody>
        </x-admin.table.default>
    ...
    @pushonce('vite')
        @vite(['resources/assets/js/admin/tables/moderateTable.js', 'resources/assets/js/admin/fetchEmployer.js'])
    @endpushonce
</x-admin.layout>
