@php use App\Enums\Reason\ReasonToDeleteVacancyEnum;use App\Persistence\Models\Admin;use App\Persistence\Models\User; @endphp
<x-layout>
    ...
    <x-modal.index id="delete-forever-modal">
        <x-modal.withform title="Delete vacancy" btnActionName="Delete"
                          ...
                          withClose>
            <input type="checkbox" name="delete_type" value="{{ \App\Enums\Admin\DeleteVacancyTypeEnum::DELETE_PERMANENTLY }}" hidden checked>
            <div class="my-2">
