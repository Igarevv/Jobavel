            ...
            <div class="w-75 mx-auto">
                <form action="" method="POST">
                    <x-input.block id="createVacancyInput">
                        <x-input.index class="mb-3" type="text" label="Job title (ex. Middle Laravel Developer)" id="jobTitle" name="jobTitle" required></x-input.index>
                        <h6 class="fw-bold">(Optional) Salary in $</h6>
                        <div class="input-group mb-3">
                            <span class="input-group-text">$</span>
                            <x-input.index type="number" name="salary" id="salary" min="0"></x-input.index>
                        </div>
                        <x-input.textarea class="mb-3" name="description" label="About job" id="description"></x-input.textarea>
